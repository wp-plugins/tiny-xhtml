...
var TinyMCE_XHTMLXtrasPlugin = {
	...
	initInstance : function(inst) {
		tinyMCE.importCSS(inst.getDoc(), tinyMCE.baseURL + "/../../../wp-content/plugins/tiny-xhtml/xhtmlxtras/css/xhtmlxtras.css");
	},
	...
	execCommand : function(editor_id, element, command, user_interface, value) {
		...
		switch (command) {
			case "mceCite":
				...
				template = new Array();
				template['file'] = '../../../../../wp-content/plugins/tiny-xhtml/xhtmlxtras/cite.htm';
				template['width'] = 350;
				template['height'] = 250;
			...
			case "mceAcronym":
				...
				template = new Array();
				template['file'] = '../../../../../wp-content/plugins/tiny-xhtml/xhtmlxtras/acronym.htm';
				template['width'] = 350;
				template['height'] = 250;
				tinyMCE.openWindow(template, {editor_id : editor_id});
				return true;
			...
			case "mceAbbr":
				...
				template = new Array();
				template['file'] = '../../../../../wp-content/plugins/tiny-xhtml/xhtmlxtras/abbr.htm';
				template['width'] = 350;
				template['height'] = 250;
				tinyMCE.openWindow(template, {editor_id : editor_id});
				return true;
			...
			case "mceIns":
				...
				template = new Array();
				template['file'] = '../../../../../wp-content/plugins/tiny-xhtml/xhtmlxtras/ins.htm';
				template['width'] = 350;
				template['height'] = 310;
				tinyMCE.openWindow(template, {editor_id : editor_id});
				return true;
			...
			case "mceDel":
				...
				template = new Array();
				template['file'] = '../../../../../wp-content/plugins/tiny-xhtml/xhtmlxtras/del.htm';
				template['width'] = 350;
				template['height'] = 310;
				tinyMCE.openWindow(template, {editor_id : editor_id});
				return true;
			...
			case "mceAttributes":
				...
				if (elm && elm.nodeName !== 'BODY' && elm.className.indexOf('mceItem') == -1) {
					tinyMCE.openWindow({
						file : '.../../../../../wp-content/plugins/tiny-xhtml/xhtmlxtras/attributes.htm',
						width : 380,
						height : 370
					}, {editor_id : editor_id});
				}
